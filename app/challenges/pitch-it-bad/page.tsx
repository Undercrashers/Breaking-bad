...
export default function PitchItBadSubmission() {
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-4 mb-8">
              ...
              <p className="text-white/70 text-lg">
                Submit your innovative startup concept and compete for 25
                points!
              </p>
              <div className="pt-4">
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  required
                  placeholder="Describe your startup concept in one sentence"
                  rows={2}
                  className="w-full px-4 py-3 rounded-lg bg-white/5 border border-green-400/30 text-white placeholder-white/40 focus:border-green-400 focus:outline-none transition-colors resize-none"
                />
              </div>
